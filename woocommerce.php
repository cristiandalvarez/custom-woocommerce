<?php
	...
	function apostadores_woocommerce_text( $translated_text, $text, $domain ) {
		switch ( $translated_text ) {
			case 'Facturación Nombre es un campo requerido' :
			...
			break;
			case 'Por favor, lee y acepta los términos y condiciones para proceder con tu pedido.' :
			$translated_text = __( 'Debe aceptar los términos y las políticas de privacidad para continuar.', 'woocommerce' );
			break;
		}
